...
public class OrderDTO implements Serializable {
	...
	public OrderDTO(Long id, Instant moment, OrderStatus orderStatus, Long clienteId, String clientName,
			String clientEmail) {
		this.id = id;
		this.moment = moment;
	...
	public OrderDTO(Order entity)  {
		...
		if(entity.getClient() == null){
			throw new IllegalAddException("Error instantiating OrderDTO: client was null");
